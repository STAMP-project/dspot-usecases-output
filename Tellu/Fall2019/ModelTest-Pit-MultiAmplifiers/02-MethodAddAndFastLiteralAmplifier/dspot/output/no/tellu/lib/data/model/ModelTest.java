...
public class ModelTest {
    ...
    @Test(timeout = 1000)
    public void testInitFromFile_add53394() throws IOException, DataNotFoundException {
        ...
        DataModelHandle o_testInitFromFile_add53394__10 = model.getDataHandle("/header/length");
        Assert.assertFalse(((DataModelHandle) (o_testInitFromFile_add53394__10)).hasOpenTransaction());
        Assert.assertTrue(((DataModelHandle) (o_testInitFromFile_add53394__10)).isValid());
        Assert.assertTrue(((DataModelHandle) (o_testInitFromFile_add53394__10)).hasNode());
        Assert.assertTrue(((DataModelHandle) (o_testInitFromFile_add53394__10)).isValueNode());
        Assert.assertEquals("length", ((DataModelHandle) (o_testInitFromFile_add53394__10)).getName());
        DataHandle handle = model.getDataHandle("/header/length");
        boolean boolean_4083 = (handle.totalNodes()) == 1;
        boolean boolean_4084 = (handle.getFloat(null)) == 1.234F;
        handle = model.getDataHandle("/header/array");
        boolean boolean_4085 = (handle.totalNodes()) == 3;
        boolean o_testInitFromFile_add53394__21 = handle.getString(null).equals("str1");
        Assert.assertTrue(o_testInitFromFile_add53394__21);
        handle = model.getDataHandle("/person");
        boolean boolean_4086 = (handle.totalNodes()) == 2;
        System.out.print("\n");
        Assert.assertFalse(((DataModelHandle) (o_testInitFromFile_add53394__10)).hasOpenTransaction());
        Assert.assertTrue(((DataModelHandle) (o_testInitFromFile_add53394__10)).isValid());
        Assert.assertTrue(((DataModelHandle) (o_testInitFromFile_add53394__10)).hasNode());
