...
public class ModelTest {
    ...
    @Test(timeout = 1000)
    public void testSubscriberslitString169315_failAssert0() throws IOException {
        try {
            ...
            handle.setValue(":*!Py{YE-o]Y?T", 2.0F);
            ...
            advancedSub.wasCalled();
            System.out.print("\n");
            org.junit.Assert.fail("testSubscriberslitString169315 should have thrown ClassCastException");
        } catch (ClassCastException expected) {
            Assert.assertEquals("no.tellu.lib.data.DataValueNode cannot be cast to no.tellu.lib.data.DataGroupNode", expected.getMessage());
        }
    }
}
