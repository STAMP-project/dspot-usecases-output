...
public class ModelTest {
    ...
    @Test(timeout = 10000)
    public void testSubscribers_add18644_add19242() throws IOException {
        ...
        boolean o_testSubscribers_add18644__40 = rootSub.wasCalled();
        boolean o_testSubscribers_add18644__41 = arraySub.wasCalled();
        DataHandle o_testSubscribers_add18644_add19242__46 = handle.getDataHandle("/header");
        Assert.assertFalse(((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).hasOpenTransaction());
        Assert.assertTrue(((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).isValid());
        Assert.assertTrue(((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).hasNode());
        Assert.assertFalse(((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).isValueNode());
        Assert.assertEquals("header", ((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).getName());
        ...
        boolean o_testSubscribers_add18644__49 = rootSub.wasCalled();
        boolean o_testSubscribers_add18644__50 = arraySub.wasCalled();
        boolean o_testSubscribers_add18644__51 = phoneSub.wasCalled();
        boolean o_testSubscribers_add18644__52 = advancedSub.wasCalled();
        handle.startTransaction();
        handle.setValue("/person[1]/phone[1]/number", "98765432");
        handle.commitTransaction();
        boolean o_testSubscribers_add18644__56 = rootSub.wasCalled();
        boolean o_testSubscribers_add18644__57 = rootSub.wasCalled();
        boolean o_testSubscribers_add18644__58 = phoneSub.wasCalled();
        boolean o_testSubscribers_add18644__59 = phoneSub.wasCalled();
        boolean o_testSubscribers_add18644__60 = advancedSub.wasCalled();
        model.clearDataSubscribers();
        handle.startTransaction();
        handle.setValue("/person[2]/phone[1]/number", "27491646");
        handle.commitTransaction();
        boolean o_testSubscribers_add18644__65 = phoneSub.wasCalled();
        boolean o_testSubscribers_add18644__66 = advancedSub.wasCalled();
        boolean o_testSubscribers_add18644__67 = advancedSub.wasCalled();
        System.out.print("\n");
        Assert.assertTrue(((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).hasOpenTransaction());
        Assert.assertTrue(((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).isValid());
        Assert.assertTrue(((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).hasNode());
        Assert.assertFalse(((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).isValueNode());
        Assert.assertEquals("header", ((DataModelHandle) (o_testSubscribers_add18644_add19242__46)).getName());
